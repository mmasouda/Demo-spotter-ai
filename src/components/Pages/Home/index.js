...
import { SearchBar, StyledAccordion } from "../../../components";
import {
    Container,
    Banner
} from "./Styles";
...
export const Home = (props) => {
    ...
    return (
        <Container>
            ...
            {faqStr?.map((question) => <StyledAccordion question={question.question} answer={question.answer} />)}
        </Container>
    )
}